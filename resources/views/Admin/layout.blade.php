                    ...
                    <div class="slimscroll-menu">
                        ...
                        <div id="sidebar-menu" style="display: flex; flex-direction:column;">
                            ...
                            <span class="logo-lg d-flex justify-content-center mb-4 tshi-logo" style="">
                                <img class="lg-l" src="assets/images/logo-light.png" alt=""
                                    @if(request()->url() === url('profile'))
                                        width="100"
                                    @else
                                        height="62"
                                    @endif
                                    style="filter: brightness(40%) sepia(100%) hue-rotate(200deg);">
                                    <img src="assets/images/logo-sm.png" alt="" height="20" class="sm-l mt-4">
                            </span>
                            ...
                            <ul class="metismenu" id="side-menu">
                                ...
                                @if(request()->url() == url('dashboard') || request()->url() == url('tables-member-capture-in-progress') || request()->url() == url('tables-claims-completed') || request()->url() == url('tables-claims-in-progress') || request()->url() == url('/'))
                                    <li>
                                        <a class="Actionpreload navi-item" href="{{('/')}}" style="color: white">
                                ...
                                @else
                                    <li>
                                        <a class="navi-item" href="{{('/')}}" style="color: white">
                                            <div class="d-flex align-items-center" style="" >
                                                <i class="mdi mdi-view-dashboard"></i>
                                                <span>Dashboard</span>
                                            </div>
                                    ...
                                    <div class="offcanvas-body">
                                        <ul class="metismenu" id="side-menu">
                                            ...
                                            @if(request()->url() == url('dashboard') || request()->url() == url('/'))
                                                <li>
                                                    <a class="Actionpreload navi-item" href="{{('/')}}" style="color: black">
                                            ...
                                            @else
                                                <li>
                                                    <a class="Actionpreload" href="{{('/')}}" style="color: black">
                                                        <hr style="padding: 0em; margin:0em">
                                                        <i class="mdi mdi-view-dashboard"></i>
                                                        Dashboard
                                                        <hr style="padding: 0em; margin:0em">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right profile-dropdown" style="background:#c1c6db">
                                        ...
                                        <div class="dropdown-item notify-item">
                                            ...
                                            <form class="navform" method="POST" action="{{ route('logout') }}">
                                                @csrf
                                                <button style="background:none; border:none; display: flex; align-items: center; justify-content: center;" type="submit">Log Out</button>
                                            </form>
