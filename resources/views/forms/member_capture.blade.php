                    ...
                    <div class="col-12" style="">
                        <div class="">
                            ...
                            <div class="row mt-3" style="background: none">
                                <div class="col-12" style="padding: 0 1em; z-index: 0; background: none;">
                                    <h5>Member Capture</h5>

                                    {{-- Progress Blocks --}}
                                    <div class=" mb-4 mt-4 progress" style="z-index: 0">
                                    ...
                                    <form id="wizard-validation-form"  >
                                        <div>
                                            ...
                                            <section>
                                                ...
                                                <div class="table-responsive" style="width: 100%; border: none; border-radius: 0.5em; overflow-x: auto;">
                                                    ...
                                                    <table id="datatable" class="table table-sm tablestriped align-middle data-table " style="width: 100%; margin-bottom: 0; border:none; font-family: 'Helvetica Neue', Arial, sans-serif;">
                                                        <thead class="text-center" style="background:#010e46;color:rgba(255, 255, 255, 0.912)">
                                                            <tr>
                                                                <th style="padding:0.5em; vertical-align: top;">Main Member Full Names</th>
                                                                ...
                                                                <th style="padding:0.5em; vertical-align: top;">Extended Name</th>
                                                                <th style="padding:0.5em; vertical-align: top;">Extended Surname</th>
                                                                <th style="padding:0.5em; vertical-align: top;">Policy Number</th>
                                                                <th style="padding:0.5em; vertical-align: top;">Branch Name</th>
                                                                <th style="padding:0.5em; vertical-align: top;">Start Date</th>
                                                                <th style="padding:0.5em; vertical-align: top;">Inception Date</th>
                                                                <th style="padding:0.5em; vertical-align: top;">Cover Date</th>
                                            ...
                                            <section>
                                                ...
                                                <div class="table-responsive" style="width: 100%; border: none; border-radius: 0.5em; overflow-x: auto;">
                                                    <table id="datatable" class="table table-sm tablestriped align-middle data-table " style="width: 100%; margin-bottom: 0; border:none; font-family: 'Helvetica Neue', Arial, sans-serif;">
                                                        <thead class="text-light text-center" style="background:#010e46;">
                                                            <tr>
                                                        ...
                                                        <tbody id="beneficiaryMember_body" class="table-bordered">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="display: flex; align-items: center; justify-content: space-around;gap:0.5em; border:none; padding:0.5em 0;">
                                                                    <button type="button" class="btn btn-sm show-confirm action" onclick="editMember({{ $beneficiaryMember->bd_id }})" style="background:none;">
                                                        ...
                                                        if (checkFields(beneficiaryMember)) {
                                                            ...
                                                            .then(response => {
                                                                ...
                                                                if (response.error) {
                                                                    ...
                                                                    editButton.innerHTML = '<i class="fas fa-edit fa-lg"></i>';
                                                                    editButton.addEventListener("click", function() {
                                                                        editMember(response.beneficiaryMember.bd_id);
                                                                    });
                                            ...
                                            <section>
                                                ...
                                                <div class="row" class="p-3">
                                                    <a href="{{('/pdfgenerate')}}" class="btn btn-sm text-white mt-2 Actionpreload pdfButton mb-4" style="background-color:#010e46; margin-top:0em ! important; cursor: pointer;">
                                            ...
                                            <script>
                                                ...
                                                function showTab(n) {
                                                    ...
                                                    if (currentTab === 5) {//if we are in section 6
                                                        ...
                                                        columnElements[currentTab].querySelector('.d-flex').style.backgroundColor = 'rgb(109, 110, 124)';
