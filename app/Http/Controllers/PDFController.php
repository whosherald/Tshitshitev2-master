...
class PDFController extends Controller
{
    ...
    public function domppdf(Request $request)
    {
        if (Session::has('mainMemberId')) {
            ...
            // $member_data = [
            //     'alldatas' => DB::table('main_member')
            //         ->leftJoin('policy_details', 'policy_details.mm_id', '=', 'main_member.mm_id')
            //         ->leftJoin('c', 'extended_member.mm_id', '=', 'main_member.mm_id')
            //         ->leftJoin('beneficiary_details', 'beneficiary_details.mm_id', '=', 'main_member.mm_id')
